...
public class Preguntas8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas8);
       ...
       */
        t = (TextView) findViewById(R.id.txtMensajeContinuar9);
        t.setOnClickListener(new View.OnClickListener() {

            public void onClick(View v) {Intent i = new Intent(Preguntas8.this, Preguntas9.class);
                startActivity(i);
