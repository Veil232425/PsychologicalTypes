...
public class Preguntas7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas7);
       ...
       */
        t = (TextView) findViewById(R.id.txtMensajeContinuar8);
        t.setOnClickListener(new View.OnClickListener() {

            public void onClick(View v) {Intent i = new Intent(Preguntas7.this, Preguntas8.class);
                startActivity(i);
