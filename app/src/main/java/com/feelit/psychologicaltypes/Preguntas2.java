    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /* Intent i = getIntent();
      ...
      String name=b.getString("nombre");
        ...
        */
        t = (TextView) findViewById(R.id.txtMensajeContinuar3);
        t.setOnClickListener(new View.OnClickListener() {

            public void onClick(View v) {Intent i = new Intent(Preguntas2.this, Preguntas3.class);
                startActivity(i);
                startActivity(i);
